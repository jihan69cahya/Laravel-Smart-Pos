...
@section('title_page', 'Edit Pembelian')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Edit Pembelian #{{ $data['pembelian']['no_faktur'] }}</h5>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="tanggal" name="tanggal"
                                    value="{{ $data['pembelian']['tanggal'] }}" required>
                        ...
                        <div class="row mb-3">
                                ...
                                <select class="form-select select2 select2-not-modal" id="supplier" name="supplier"
                                    ...
                                    @foreach ($data['supplier'] as $supplier)
                                        <option value="{{ $supplier->id }}"
                                            @if ($supplier->id == $data['pembelian']['id_supplier']) selected @endif>{{ $supplier->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3"
                                    placeholder="Masukkan keterangan (opsional)">{{ $data['pembelian']['keterangan'] }}</textarea>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text"
                                                    ...
                                                    id="pajak" name="pajak" min="0" step="0.01"
                                                    value="{{ $data['pembelian']['pajak'] }}">
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-6">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text"
                                                    ...
                                                    id="potongan" name="potongan" min="0"
                                                    value="{{ \App\Helpers\Money::stringToRupiah($data['pembelian']['potongan']) }}">
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                <input type="text"
                                                    class="form-control form-control-sm text-end maskRupiah"
                                                    id="biaya_tambahan" name="biaya_tambahan" min="0"
                                                    value="{{ \App\Helpers\Money::stringToRupiah($data['pembelian']['biaya_tambahan']) }}">
                                            </div>
                                        </div>
                                        <hr class="my-3">
                                        <div class="row">
...
@section('js')
    <script>
        ...
        function edit_pembelian() {
            let url_edit = "{{ route('data.pembelian.update', ['pembelian' => ':id']) }}";
            if (dataProduk.length === 0) {
            ...
            $.ajax({
                type: "POST",
                url: url_edit.replace(':id', id_pembelian),
                data: formData,
                headers: {
