    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="title_modal">Form Data Stok Opname</h4>
                ...
                <form id="formData" onsubmit="return false;">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" id="stok" name="stok" class="form-control number-only"
                            placeholder="Stok terisi otomatis..." readonly>
                        <small class="text-danger pl-1" id="error-stok"></small>
                    </div>
                    <div class="form-group mb-2">
                        <label for="jumlah_fisik">Jumlah Fisik *</label>
                        <input type="text" id="jumlah_fisik" name="jumlah_fisik" class="form-control number-only"
                            placeholder="Masukkan jumlah fisik ...">
                        <small class="text-danger pl-1" id="error-jumlah_fisik"></small>
                    </div>
                    <div class="form-group mb-2">
